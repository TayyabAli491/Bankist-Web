...
//Nav links Scroll using Event Deligation (instead of selecting individual element select their comman partent)
...
const lazyImage = function (entries, observer) {
  ...
  if (!entry.isIntersecting) return; // Clause Gaurd
